...
DEFINE_EDM_PLUGIN(HitQuadrupletGeneratorFactory, CAHitQuadrupletGenerator, "CAHitQuadrupletGenerator");
DEFINE_EDM_PLUGIN(HitTripletGeneratorFactory, CAHitTripletGenerator, "CAHitTripletGenerator");
