...
#trackingPhase1.toModify(_fastSim_initialStepSeeds, seedFinderSelector = dict( CAHitQuadrupletGeneratorFactory = dict( SeedComparitorPSet = dict(ComponentName = "none"))))
